...
def plot(xdata, title):
    ...
    img1 = axarr[0, 0].imshow(xdata[:, :, 0].T, interpolation='nearest')
    axarr[0, 0].set_title(title[0])
    plt.axes(axarr[0, 0])
    fig.colorbar(img1)

    img2 = axarr[0, 1].imshow(xdata[:, :, 1].T, interpolation='nearest')
    axarr[0, 1].set_title(title[1])
    plt.axes(axarr[0, 1])
    fig.colorbar(img2)

    img3 = axarr[1, 0].imshow(xdata[:, :, 2].T, interpolation='nearest')
    axarr[1, 0].set_title(title[2])
    plt.axes(axarr[1, 0])
    fig.colorbar(img3)

    img4 = axarr[1, 1].imshow(xdata[:, :, 3].T, interpolation='nearest')
